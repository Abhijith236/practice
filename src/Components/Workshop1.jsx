...
const Workshop1=()=>{
    ...
    return(
        <div className='w-100 h-100 bg-black'>
            <div className='Workshop_container m-lg-5 '>
                ...
                <div className='workshop1 d-flex  align-items-center justify-content-lg-start m-5  p-2' >
                    <img src={img1} alt="" className=''/>
                    <p className='p-3 m-2'>Brainwave Robotics Workshop</p>
                    <button className={`btn ${isActive ? 'active-btn':''}`} data-bs-toggle='collapse' type='button' data-bs-target='#coll1' onClick={handleClick} >
                        { isActive? 
                ...
                <div className='workshop2 d-flex m-5 align-items-center justify-content-lg-start p-2 '>
                    <img src={img2} alt="" />
                    <p className='p-3 m-2'>Digital Signal Processing using Matlab</p>
                ...
                <div className='workshop3 d-flex m-5 align-items-center justify-content-lg-start p-2'>
                    <img src={img3} alt="" />
                ...
                <div className='content3 pb-3 m-2' id='coll3' style={Border}>
                ...
                <div className='workshop4 d-flex m-5 align-items-center justify-content-lg-start p-2'>
                    <img src={img4} alt="" />
                ...
                <div className='content4 pb-3 m-2' id='coll4' style={Border}>
                    <p style={Text}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt minima magni corrupti accusantium, quo natus deleniti laudantium. Debitis modi pariatur consequuntur dolorum deserunt nobis? Distinctio in fugiat libero obcaecati nemo!</p>
                    <button className='btn btn-light' type='button'>Know More</button>
                </div>
                
                <div className='workshop5 d-flex m-5 align-items-center justify-content-lg-start p-2'>
                    <img src={img5} alt="" />
                ...
                <div className='content5 pb-3 m-2' id='coll5' style={Border}>
                    <p style={Text}>Lorem ipsum dolor sit amet consectetur adipisicing elit. Incidunt minima magni corrupti accusantium, quo natus deleniti laudantium. Debitis modi pariatur consequuntur dolorum deserunt nobis? Distinctio in fugiat libero obcaecati nemo!</p>
                    <button className='btn btn-light' type='button'>Know More</button>
                </div>
            </div>
