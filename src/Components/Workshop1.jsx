...
const Workshop1=()=>{
    const Border = {
      ...
      const btnplus={
        button:<svg width="42" height="42" viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    return(
        <>
            <div className='Workshop_container w-100 h-100 bg-black justify-content-center'>
                ...
                <div className='content1 d-flex flex-column  m-5 align-items-center  justify-content-lg-start' id='coll1' style={Border}>
