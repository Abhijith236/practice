    ...
    return(
        <div className='w-100 h-100 bg-black'>
            <div className='Workshop_container m-lg-5 '>
                ...
                <div className='workshop3 d-flex m-5 align-items-center  justify-content-center p-2'>
                    <img src={img3} alt="" />
                ...
                <div className='workshop4 d-flex m-5 align-items-center  justify-content-center p-2'>
                    <img src={img4} alt="" />
                ...
                <div className='workshop5 d-flex m-5 align-items-center  justify-content-center p-2'>
                    <img src={img5} alt="" />
