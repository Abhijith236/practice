            ...
            <div className="accordion" id='workshop'>
                <div className="accordion-item">
                    <h2 className='accordion-header' id='heading1'>
                        <button className='accordion-button collapsed' type="button" data-bs-toggle="collapse" data-bs-target="#workshop1" aria-expanded="false" aria-controls="workshop1">
                            <img src={img1} alt="" className='workshop-img' />
                ...
                <div className="accordion-item">
                    <h2 className='accordion-header' id='heading2'>
                        ...
                        <img src={img2} alt="" className='workshop-img'/>
                ...
                <div className="accordion-item">
                    <h2 className='accordion-header' id='heading3'>
                        ...
                        <img src={img3} alt="" className='workshop-img' />
                ...
                <div className="accordion-item">
                    <h2 className='accordion-header' id='heading4'>
                        ...
                        <img src={img4} alt=""className='workshop-img'/> 
                ...
                <div className="accordion-item">
                    <h2 className='accordion-header' id='heading5'>
                        ...
                        <img src={img5} alt="" className='workshop-img'/>
